...
document.write('This is the first random nunmbers ' + randomNumbers);

// Now the problem here is that I don't know if the genrated numbers here were from the first random numbers
// Help me !
let newRandomNumbers = Array.from({randomNumber, length: 10}, () => Math.floor(Math.random() * 10));

document.write('This is the second random numbers ' + newRandomNumbers);
